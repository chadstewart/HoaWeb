                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="clearfix">
                            ...
                            <div class="col-sm-6 col-md-5">
                                    <select id="delete-selector" name="delete">
					
				    </select>
				    <input type="hidden" name="apiFunction" value="activitybooks" >
                                </div>
                                <div class="mg-top-5">
                                    <input type="submit" value="Delete Activitybook" class="btn btn-block login-white-btn">
                                </div>
